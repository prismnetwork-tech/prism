      ...
      "/inference/v1/inference": {
        post: {
          ...
          responses: {
            ...
            429: { description: "No GPU is warm yet. Retry after the seconds given; nothing was charged." },
            503: { description: "No GPU came up for the request, or the one that took it could not answer. Nothing was charged." },
          },
        },
      },
      "/inference/v1/batch": {
        post: {
          ...
          responses: {
            ...
            402: { description: "Payment Required" },
            429: { description: "No GPU is warm yet. Retry after the seconds given; nothing was charged." },
            503: { description: "No GPU came up for the batch, or it could not finish on the ones that did. Nothing was charged." },
          },
        },
      },
      "/inference/v1/models": {
