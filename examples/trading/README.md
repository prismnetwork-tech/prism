...
execution adapter and the same skeleton covers other venues — Arcus, the perps
DEX on Robinhood Chain, fits the Lighter slot once its API opens beyond the
current waitlist beta.
...
AG2/AutoGen, elizaOS, or Virtuals GAME ([integrations](../../integrations)) —
