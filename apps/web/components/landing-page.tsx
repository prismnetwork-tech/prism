        ...
        <section className="landing-section security-section" id="security">
          ...
          <div className="security-copy">
            ...
            <div className="security-disclosure">
              ...
              <p>A rented workspace is a different question: today&rsquo;s capacity is open class, so its operator can read what runs there. That is why new vault items start out of reach of it, and why stronger classes are earned from hardware attestation rather than a supplier&rsquo;s own claim.</p>
            </div>
          </div>
        </section>
