    ...
    <div className="docs-page">
      <header className="docs-header">
        ...
        <nav aria-label="Documentation header">
          <a href="https://github.com/winter0x/prism" target="_blank" rel="noopener noreferrer">GitHub ↗</a>
        ...
        <main className="docs-content" id="main-content" tabIndex={-1}>
          <section className="docs-hero" id="overview">
            ...
            <div className="docs-hero-actions">
              ...
              <a className="landing-button secondary" href="https://github.com/winter0x/prism" target="_blank" rel="noopener noreferrer">Read source <span>↗</span></a>
            </div>
